        ...
        <div class="bg-light rounded p-4">
            <form action=" ../../controller/cliente/salvar_cliente.php" method="POST" class="row">
                ...
                <div class="col-12 col-lg-2 mb-3">
                    ...
                    <input type="text" name="telefone" id="telefone" pattern="\d{11}" oninput="this.value = this.value.replace(/\D/g, '')" maxlength="11" placeholder="Digite o telefone" class="form-control">
                </div>
